...
// // Use conditional imports if you need platform-specific code
...
//         return WebSocketMessageType.emergencyRequest;
...
//         'userId': userId,
//         'role': _getUserRoleString(
//           userRole,
//         ), // Changed from 'userRole' to 'role'
...
//       try {
//         // Use WebSocketChannel.connect for better cross-platform compatibility
...
//     sendMessage(
//       WebSocketMessage(
//         type: WebSocketMessageType.emergencyRequest,
//         userId: _currentUserId,
//         data: {
//           'patientId': patientId,
...
//   trackingRoomLeft,
//   fleetStatusUpdate,
//   hospitalFleetStatus, // Add this new type
//   connect,
//   heartbeat,
//   heartbeatAck,
//   error,
...
//     return WebSocketMessage(
//       type: _parseMessageType(json['type']),
//       data: json['data'] ?? json, // Use entire json if no 'data' field
//       emergencyId: json['emergencyId'],
//       userId: json['userId'],
//       hospitalId: json['hospitalId'],
//     );
...
//       case 'fleetStatusUpdate':
//         return WebSocketMessageType.fleetStatusUpdate;
//       case 'hospitalFleetStatus': // Add this case
